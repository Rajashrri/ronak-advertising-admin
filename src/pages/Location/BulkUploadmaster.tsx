...
export default function BulkUpload() {
  ...
  const fetchBulkUploads = async () => {
    try {
      ...
      const response = await getBulkUploadListApi(
        page,
        limit,
        search
      );
  ...
  return (
    <>
      <PageBreadcrumb
        pageTitle="Bulk Upload Location Master"
      />

      <div className="space-y-6">
        <ComponentCard
          title="Bulk Upload Location Master"
        >
...
<a
  href="/sample/location-bulk-upload.xlsx"
